...
tf = 64 ;             % Tiempo de simulacion en segundos (s)
...
u = [0,     4,          0,     4,     0,      2,  0,        1,  0,      3,   0,     1,  0,        3,      0,     3,     0,           2,      0,         3,      0,         1,     0,        4,      0,         2,      0,         2,      0,         2,      0,        5,      0,          3      ,0         3,      0,         2,      0,      3,      0,        1,      0,           1,      0,          2,       0,        3.5,      0,      3.5,      0,      3,      0,         1,         0,       1          0,       2,        0,      4,      0,      2,       0,      2,0,0,];
w = [pi/2,  0,      -pi/4,     0,     -pi/4,  0,  -pi/2,    0,  -pi/4,  0,  -pi/3,  0,  1.9,      0,      -4.1,   0,    -0.725,      0,     -0.77,       0,     0.78,      0,    pi/2,      0,      -2.5,      0,      0.94,      0,      pi/4,      0,     -2.4,      0,      -pi/4,      0,    -pi/2       0,      0.8,       0       pi/2,   0,      pi/2,      0,      -pi/2,      0,      -pi/2,      0,       -pi/2,    0,        pi/2,   0,        pi/2,   0,      pi/2,      0,      -pi/2,      0,      -pi/2,      0,       -pi/2,     0,     pi/2,   0,      -pi/2,  0,0,0]; %
...
axis([-1 16 -0 14 0 2]); % Ingresar limites minimos y maximos en los ejes x y z [minX maxX minY maxY minZ maxZ]
