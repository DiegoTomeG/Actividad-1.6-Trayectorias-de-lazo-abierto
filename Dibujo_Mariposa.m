...
tf = 55 ;             % Tiempo de simulacion en segundos (s)
...
u = [0,     0,      1.3,    0,       3.5,      0,       1,      0,         1,      0,         2,      0,        3.5,      0,        2.5,      0,         1,      0,      1,      0,        2.6,     0,         2.6,      0,        5.1,          0,       1.3,       0,                      0,     0,      1.3,    0,       3.5,      0,       1,      0,         1,      0,         2,      0,        3.5,      0,        2.5,      0,         1,      0,      1,      0,        2.6,     0,         2.6,      0,        5.1,          0,       0,       0];
w = [pi/2,  0.78,    0,    1.4,      0,      -1.6,      0,      -0.6,      0,      -0.85,      0,     1.4,      0,        -1.4,      0,       -0.74,      0,     -0.6,    0,       1.4,      0,       3.14       0       0.8       0,          0.7,       0,         0.9,                   pi/2,  -0.78,    0,    -1.4,      0,      1.6,      0,      0.6,      0,      0.85,      0,     -1.4,       0,        1.4,      0,       0.74,      0,     0.6,    0,       -1.4,      0,       -3.14       0       -0.8       0,          0.7,       0,         0.9]; 
...
axis([-7 7 -2 10 0 2]); % Ingresar limites minimos y maximos en los ejes x y z [minX maxX minY maxY minZ maxZ]
